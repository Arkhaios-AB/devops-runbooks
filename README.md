...
| **Workloads** | [Pod Not Ready](./workloads/pod-not-ready.md) | Troubleshoot pods stuck in Not Ready state | • Pod status shows "Not Ready"<br>• Readiness probe failures<br>• Service cannot route traffic to pod |
